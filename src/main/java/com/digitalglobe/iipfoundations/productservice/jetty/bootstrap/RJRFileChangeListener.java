...
/**
 * For more details controll we need, ex. when add a folder , it's unncessory to restart.
 *
 * @author tony
 *
 */
public class RJRFileChangeListener implements Scanner.BulkListener, Scanner.DiscreteListener {
    ...
    private ConfigJetty config;
    private boolean init = false;
    private Set<String> folderSet;
    private boolean isDirty = false;
    private Set<String> dirtylist = new HashSet<String>();

    public RJRFileChangeListener(WebAppContext web, ConfigJetty config) {
        super();
