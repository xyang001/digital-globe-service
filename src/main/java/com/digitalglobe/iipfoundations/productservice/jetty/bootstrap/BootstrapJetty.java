...
public class BootstrapJetty {
    ...
    public static void main(String[] args) throws Exception {
        System.err.println("Running Jetty 9.0.0.M3");
        
        System.setProperty("rjrcontext", "/");
        System.setProperty("rjrwebapp", "C:\\Users\\jthiel\\Documents\\NetBeansProjects\\IIPProductServiceApp/src/main/webapp");
        System.setProperty("rjrport", "8080");
        
        ConfigJetty configs = new ConfigJetty();
    ...
    private static void initConnnector(Server server, ConfigJetty configObj) {
    ...
    private static void initEclipseListener(final ConfigJetty configs) {
        //init eclipse hook
    ...
    private static void initCommandListener(final ConfigJetty configs) {
        //init eclipse hook
